...
aws ec2 run-instances --image-id ami-0828f782ee03b55e4 --instance-type m5.xlarge --key-name haidangYAM --security-group-ids $SECURITY_ID --subnet-id $SUBNET_ID > instance.json > /dev/null 2>&1
